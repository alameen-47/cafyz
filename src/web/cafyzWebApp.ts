...
.kds-logo img{width:100%;height:100%;object-fit:cover}
    ...
    <div class="login-left">
      <div>
        <div class="login-brand">
          <div class="login-logo"><img src="/logo.png" alt="Cafyz logo"/></div>
          <div>
...
<div id="panel-manager" class="panel">
  <div class="panel-inner">
    <div class="sidebar">
      <div class="sb-brand">
        <div class="sb-logo"><img src="/logo.png" alt="Cafyz logo"/></div>
...
<div id="panel-kds" class="panel" style="flex-direction:column">
  <div class="kds-header">
    <div class="kds-hl">
      <div class="kds-logo"><img src="/logo.png" alt="Cafyz logo"/></div>
