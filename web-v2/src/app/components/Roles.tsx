          ...
          >
            ...
            <div className="col-span-1 flex gap-1">
              <button
                ...
                title="Edit profile"
                className="p-1.5 rounded-lg hover:bg-[rgba(30,127,255,0.08)] text-[#6b82a0] hover:text-[#1e7fff] transition-all">
                <UserCog size={13} />
              </button>
              <button
      ...
      <div className="rounded-2xl overflow-hidden" style={{ background: "#0d1326", border: "1px solid rgba(30,127,255,0.1)" }}>
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <span style={{ color: "#e8eef8", fontFamily: "var(--font-display)", fontWeight: 600 }}>Default Role Access</span>
          </div>
        ...
        <AnimatePresence>
          {showMatrix && (
            ...
            >
              <p className="px-4 pb-2" style={{ color: "#6b82a0", fontSize: "0.72rem" }}>
                ...
                <table className="w-full" style={{ borderCollapse: "separate", borderSpacing: "0 4px" }}>
                  ...
                  <tbody>
                    {screens.map(screen => {
                      ...
                      return (
                        <tr key={screen.id}>
                          <td style={{ color: "#a8bdd4", fontSize: "0.82rem", paddingRight: 12, paddingBottom: 6 }}>{screen.label}</td>
      ...
      <AnimatePresence>
        {accessEditId && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4"
            ...
            >
              <div className="flex items-center justify-between">
                <h3 style={{ fontFamily: "var(--font-display)", color: "#e8eef8", fontWeight: 700 }}>Edit Screen Access</h3>
                <button onClick={() => setAccessEditId(null)} style={{ color: "#6b82a0" }}><X size={18} /></button>
              </div>
                ...
                {screens.map(screen => {
                  ...
                  return (
                    <div key={screen.id} className="flex items-center justify-between py-1.5">
                      <span style={{ color: "#a8bdd4", fontSize: "0.82rem" }}>{screen.label}</span>
                      <button
                        onClick={() => {
      ...
      <AnimatePresence>
        {editUserId && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4"
            ...
            >
              <div className="flex items-center justify-between">
                <h3 style={{ fontFamily: "var(--font-display)", color: "#e8eef8", fontWeight: 700 }}>Edit Team Member</h3>
                <button onClick={() => setEditUserId(null)} style={{ color: "#6b82a0" }}><X size={18} /></button>
              </div>
              <div className="space-y-3">
                <div>
                  <label style={{ color: "#a8bdd4", fontSize: "0.78rem", display: "block", marginBottom: 4 }}>Full Name</label>
                  <input type="text" value={editDraft.name} onChange={e => setEditDraft(d => ({ ...d, name: e.target.value }))}
                    className="w-full rounded-xl px-3 py-2.5 text-sm outline-none"
                    style={{ background: "#111b35", color: "#e8eef8", border: "1px solid rgba(30,127,255,0.12)" }} />
                </div>
                <div>
                  <label style={{ color: "#a8bdd4", fontSize: "0.78rem", display: "block", marginBottom: 4 }}>Email</label>
                ...
                <div className="rounded-xl p-3 flex items-center justify-between" style={{ background: "#111b35", border: "1px solid rgba(30,127,255,0.08)" }}>
                  <span style={{ color: "#a8bdd4", fontSize: "0.82rem" }}>Active</span>
