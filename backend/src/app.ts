...
app.use('/api/kds',              mutationLimiter, requireAuth, requireActiveSubscription, requireSectionAccess('kds'),       kdsRoutes);
app.use('/api/reservations',     mutationLimiter, requireAuth, requireActiveSubscription, requireSectionAccess('manager'),   reservationRoutes);
app.use('/api/inventory',        mutationLimiter, requireAuth, requireActiveSubscription, requireSectionAccess('inventory'), inventoryRoutes);
